...
print(
    timeit('recursive_reverse_mem(num_100)', setup='from __main__ import recursive_reverse_mem, num_100', number=10000))
...
"""вторая функция быстрее потому что мы берем из кэша уже перевернутое число
функция полезна для многократного вызова, а не для одиночного."""
