...
"""
Получается, что усовершенствованный алгоритм в целом работает немного медленнее, 
чем классический, потому что в него добавлен счетчик и дополнительная проверка. 
Но когда функции передается уже отсортированный массив, усовершенствованный алгоритм
