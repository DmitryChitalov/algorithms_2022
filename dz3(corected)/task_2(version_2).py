"""
Задание 2.
Тут я попробывал связать скрип с базой данных, записывать и извлекать данные из БД получилось,
 но код получился грамозкий.
...
def gen_pass():
    ...
    result.append(password_hash(password_user))
    ...
    res_2 = password_hash(password_2)
