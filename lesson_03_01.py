...
"""
Замер 1:
Время выполнения list_fill: 5.66000000000004e-05
Время выполнения dict_fill: 6.099999999998468e-06
Замер 2:
Время выполнения list_fill: 2.0799999999997903e-05
Время выполнения dict_fill: 7.80000000000225e-06
Словарь заполняется дольше из-за хеширования
"""
...
@time_decorator
def delete_item_from_lst(lst, idx=None):  # O(1)
    try:
        return f'Удален элемент - {lst.pop(idx)}'
    except IndexError:
        return print('Out of range')
...
print(delete_item_from_lst(example_list, 9))
...
"""
Операции со словарем выполняются быстрее, в отличие от заполнения, у словарей константная сложность
Время выполнения take_list_item: 7.900000000001656e-06
Время выполнения take_from_dict: 2.0199999999997997e-05
***
Время выполнения delete_item_from_lst: 6.4000000000001556e-06
Время выполнения delete_from_dict : 4.799999999999249e-06
"""