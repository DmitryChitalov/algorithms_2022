...
'''При однократном вызове функции мемоизация не нужна, так как тратится время на
наполнение кэша. Мемоизация в данном примере имеет смысл применять только при
многократном вызове функции, когда кэш уже наполнен'''