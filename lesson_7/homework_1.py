...
"""
Убрал из замеров копирование оригинального списка, чтобы увидеть разницу с 
измененным, в результате замера видно, что при проходах, даже по уже 
упорядоченному списку, если не прерывать цикл, то уходит времени меньше, 
