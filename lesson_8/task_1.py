...
if __name__ == '__main__':
    string_for_code = input('Введите строку, которую нужно закодировать: ')
    example = Huffman(string_for_code)
    print(f'Ваша строка: {string_for_code}')
    print(f'Закодированная строка: {example.encoding()}')
    print(f'Таблица с кодами: {example.code_table}')
