...
# возник вопрос, находится около вызова функции (см. "for j in (10, 1500, 1000, 5000, 10000):")
...
def check_2(lst_obj):
    ...
    for j in range(len(lst_obj)):          # O(N)
        if lst_obj[j] in lst_obj[j+1:]:    # O(N)  поиск в списке
            return False                   # O(1)
    return True                            # O(1)
...
for j in (10, 1500, 1000, 5000, 10000):  # зачем нужны "10, 1500, 1000, 5000", если на выходе 10 тыс. элементов? такой
# же результат получился бы, если было, например, for j in (5000, 10000)
