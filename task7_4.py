...
10 элементов
Стандартная сортировка за 0.015
Оптимизированная сортировка за 0.018
100 элементов
Стандартная сортировка за 0.56
Оптимизированная сортировка за 0.66
1000 элементов
Стандартная сортировка за 71.5
Оптимизированная сортировка за 73.2
Сложность  O(n^2), доработка не помогла, будет эффективна при подаче на вход отсортированного массива (for in не выполнился).
"""
