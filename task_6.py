...
if __name__ == '__main__':
    ...
    print(TB_OBJ.is_empty_unsolved())  # -> True. Очередь пустая
    print(TB_OBJ.is_empty_solved())  # -> True. Очередь пустая
    print(TB_OBJ.is_empty_resolved())  # -> True. Очередь пустая
    ...
    print(TB_OBJ.is_empty_unsolved())  # -> False. Очередь не пустая
    print(TB_OBJ.is_empty_solved())  # -> True. Очередь пустая
    print(TB_OBJ.is_empty_resolved())  # -> True. Очередь пустая

    print(TB_OBJ.size_unsolved())  # -> 6

    print(TB_OBJ.from_unsolved_to_solved())  # -> задачу 1 из нерешенных в решенные

    print(TB_OBJ.size_unsolved())  # -> 5

    print(TB_OBJ.size_solved())  # -> 1

    print(TB_OBJ.from_unsolved_to_solved())  # -> задачу 2 из нерешенных в решенные

    print(TB_OBJ.size_unsolved())  # -> 4

    print(TB_OBJ.size_solved())  # -> 2

    print(TB_OBJ.from_solved_to_resolved())  # -> задачу 1 из решенных на доработку

    print(TB_OBJ.size_solved())  # -> 1

    print(TB_OBJ.size_resolved())  # -> 1

    print(TB_OBJ.from_solved())  # -> 2

    print(TB_OBJ.from_resolved_to_solved())  # -> задачу 1 из доработки в решенные

    print(TB_OBJ.size_resolved())  # -> 0

    print(TB_OBJ.size_solved())  # -> 1

    print(TB_OBJ.from_solved())  # -> 1
