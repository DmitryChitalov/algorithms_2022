...
'''
На коротком исходном массиве длительность, в порядке возрастания: func_1, func_2, func_3
На увеличенном массиве, полученном умножением исходного на 5: func_3, func_1, func_2
Превосходство func_3 возрастает с увеличением коэффициента <число элементов> / <число различных элементов>.
