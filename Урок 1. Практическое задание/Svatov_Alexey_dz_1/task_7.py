...
sys.path.append('/home/alexeysvatov/Python developer/python_algorithms_webinar/Урок 1. Практическое задание/'
                'Урок 1. Коды примеров/structures_examples/deque')
