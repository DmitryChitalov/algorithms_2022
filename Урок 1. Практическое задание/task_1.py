...
def check_1(lst_obj):
    ...
    return lst_to_set  # !!!  0(1)константная
...
def check_2(lst_obj):
    ...
    for j in range(len(lst_obj)):          # !!! O(n)линейная
        if lst_obj[j] in lst_obj[j+1:]:    # !!! O(n)линейная
            return False                   # !!! 0(1)константная
    return True                            # !!! 0(1)константная
