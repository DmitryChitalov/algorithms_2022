...
def check_1(lst_obj):
    ...
    """
    lst_to_set = set(lst_obj)  # O(len(list_obj)) линейная
...
def check_2(lst_obj):
    ...
    Сложность: O(N^2) квадратичная (O(N) вложенная в цикл O(n))
    """
...
def check_3(lst_obj):
    ...
    Сложность: O(n*log n) по максимальной сложности операции sort
    """
