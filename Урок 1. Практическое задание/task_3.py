...
"""
Вывод:
Алгоритм 2 эффективнее, так как здесь используется линейно-
логарифмическое время (асимптотического поведения функций).
Алгоритм 1 использует квадратичное время, время выполнения 
алгоритма зависит от квадрата размера входных данных.
"""