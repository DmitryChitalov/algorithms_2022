...
"""
ВЫВОД: Функция second_way со сложностью O(N) является наиболее эффективным, 
так как обладает наименьшей сложностью, 
кроме того ее совсем несложно поддерживать при текущем ТЗ
"""