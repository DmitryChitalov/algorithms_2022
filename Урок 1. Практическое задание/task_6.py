...
class QueueClass:
    ...
    def to_queue(self, item):
        return self.base.insert(0, item)

    def from_queue(self):
        return self.base.pop()

    def to_solved(self):
        return self.base.insert(0, self.base.pop())

    def to_revision(self):
        return self.revision.insert(0, self.base.pop())

    def return_from_revision_to_base(self):
        return self.base.insert(0, self.revision.pop())
