...
# Необходимо в функцию pal_checker добавить строку: string = string.replace(" ", "") - отметила ниже комментарием
...
def pal_checker(string):
    dc_obj = DequeClass()
    string = string.replace(" ", "")  # Вот эту строчку добавляем, удаление пробелов
