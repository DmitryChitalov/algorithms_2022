...
def pal_checker(string):
    ...
    temp_st = string.split(' ')   # Разбиваем строку на подстроки без пробельных символов
    temp_st_2 = str()

    for i in range(len(temp_st)):  # Проходим по списку из нужных подстрок
        temp_st_2 += temp_st[i]     # Конкантенацией получаем исходную строку без пробельных символов
