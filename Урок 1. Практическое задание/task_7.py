...
# Было уже похожее задание, только нужно было сделать, что бы функция принимала строку, не зависимо, от регистра ввода.
# Там тоже всю строку в lower() или upper() преобразуешь и с ней работаешь. Тут тоже самое.
