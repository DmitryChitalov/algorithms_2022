...
if __name__ == '__main__':
    ...
    def pal_checker(string):
        dc_obj = DequeClass()
        string = ''.join(string.lower().split())  # убираем лишние пробелы и приводим к нижнему регистру
    ...
    print(pal_checker("тут"))
    print(pal_checker("шалаш"))
    print(pal_checker("Лёша на полке клопа нашёл"))
    print(pal_checker("Я арка края"))
    print(pal_checker("А в Енисее синева"))
