...
class DequeClass:
    ...
    def pal_checker(self, string):
        ...
        return still_equal, string

dc_obj = DequeClass()
print(dc_obj.pal_checker("а роза упала на лапу азора"))
print(dc_obj.pal_checker("самолет летел очень низко"))
print(dc_obj.pal_checker("а путана тупа"))
print(dc_obj.pal_checker("не гни папин ген"))