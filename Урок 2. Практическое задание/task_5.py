...
# Функция chr() вернет строку, представляющую символ,
# соответствующий переданному в качестве аргумента целому числу из таблицы символов Unicode.


def ascii_row(symbol_ascii):
    if symbol_ascii == 128:
        return True
    print(f'{symbol_ascii} - {chr(symbol_ascii)}', end=' ')
    if (symbol_ascii - 31) % 10 == 0:
        print('\n')

    ascii_row(symbol_ascii + 1)
