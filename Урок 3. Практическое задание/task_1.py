...
if __name__ == "__main__":
   ...
   # Словарь представляет из себя хеш-таблицу, его заполнение происходит медленнее
   # из-за необходимости вычисления хеш-значений
   ...
   # Скорость получения элемента в словаре происходит быстрее, так как
   # словарь представляет из себя хеш-таблицу.
