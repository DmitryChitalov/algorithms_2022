...
# Использование list ccomprehension быстрее эквивалентного цикла for, скорее всего, потому, что ему
# не нужно искать список и его метод добавления на каждой итерации.