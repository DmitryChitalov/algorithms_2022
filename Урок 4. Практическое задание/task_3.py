...
# 3) revers_3 самый быстрый способ, за счет оптимизированного по скорости выполнения
# обратного среза, которым и реверсируется строка с числом
# 4) revers_3 на втором месте по скорости, за счет прерасчитанных данных в словаре
# ==============================================================================
