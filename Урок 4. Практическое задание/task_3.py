...
"""
Самая эффективная реализация реверса числа в функции reverse_3, 
скорость достигается из-за использования встроенных методов строки - более выстрых чем reverse()
"""
