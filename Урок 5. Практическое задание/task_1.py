...
def ent_profit():
    ...
    for _ in range(ent_count):
        ...
        ent_dict[ent_name] = enterprises(
            ent_name=ent_name,
            profit_1=int(input(f'Введите доход {ent_name} в 1 квартале: ')),
            profit_2=int(input(f'Введите доход {ent_name} во 2 квартале: ')),
            profit_3=int(input(f'Введите доход {ent_name} в 3 квартале: ')),
            profit_4=int(input(f'Введите доход {ent_name} в 4 квартале: ')))
    average_profit = 0
