...
1) метод append, pop, extend показал одинаковое время работы

2) метод appendleft в разы быстрее в deque, метод popleft в разы быстрее в deque, метод extendleft немного быстрее, 
предполагаю что с увеличением размера будет увеличиваться и разница во времени

3) получение элемента в списке немного быстрее
