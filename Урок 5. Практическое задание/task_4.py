...
По большому счету, упорядоченный словарь не имеет смысл применять в версиях Python начиная с 3.6,
с которой обычный словарь сохраняет элементы в порядке добавления.
"""