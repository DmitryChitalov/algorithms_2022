...
# Время выполенения функции fill_dict составило 1.180363199673593.
# Время выполенения функции fill_ordered_dict составило 2.567986899986863.
...
2. OrderedDict был разработан для быстрого переупорядочивания элементов и хранения их в упорядоченном виде без
перестановок а производительность в части заполнения вторична.
"""
...
# Время выполенения функции change_dict составило 0.8337669000029564.
# Время выполенения функции change_ordered_dict составило 1.5593691002577543.
