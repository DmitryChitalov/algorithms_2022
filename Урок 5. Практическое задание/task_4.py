...
"""
Обычный словарь работает быстрее чем orderdict, также в python 3.6 и выше обычный словарь 
запоминает порядок добавления элементов. Целесообразно использовать в случае, если нужны 
такие операции как move_to_end и popitem, а так же если мы хотим проверить эквивалентность словарей.
"""
