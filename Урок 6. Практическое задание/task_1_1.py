...
"""
# Урок 2 задание 2. Задача реверса числа наоборот. 
# И предположим по факту нам надо только одно число за раз
# ============= Итоги ==============
# Оригинальная программа:
# Выполнение заняло 0.62109375 Mib       
# Оптимизированная программа:
# Выполнение заняло 0.00390625 Mib
# Применилась оптимизация через создание генератора, 
# то есть будет выдаваться одно значение на запрос, соотвественно
# не требуется хранить все результаты в объекте функции
