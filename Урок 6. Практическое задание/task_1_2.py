...
"""
ДЗ_3.4 курс Алгоритмы и структуры данных на Python
"""
...
"""
использовал f-строки для вывода данных, что должно уменьшить потребление памяти, так же использовал сериализацию 
данных превратив словарь в строку используя json 
"""
check_url2('https://www.google.ru/')
