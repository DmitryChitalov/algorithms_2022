...
"""Задание 3_1 курс Основы"""


def num_translate_1(adv_en_num=None):
...
def num_translate_2(adv_en_num=None):
    """Переводит числительные от 0 до 10 с английского нужном регистре"""
...
if __name__ == '__main__':
    ...
    num_translate_1('zero')
    num_translate_2('zero')

    """
    Использование именованного кортежа позволило сократить размер
    хранимых данных с 640 до 128 байт -> пятикратный выигрыш
    """
