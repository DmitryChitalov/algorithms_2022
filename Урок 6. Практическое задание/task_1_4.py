...
r"""
Filename: C:\GIT\exchange\Урок 6. Практическое задание\task_1_4.py
...
Выводы: создание списка в цикле заменил на связку map+filter+lambda, как показывают замеры экономия памяти 
составила 1.2 MiB
"""