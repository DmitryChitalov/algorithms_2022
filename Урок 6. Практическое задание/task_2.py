...
#Алгоритмы и структуры данных на Python. Базовый курс. 2.4
@profile
...
=============================================================
    15     19.5 MiB     19.5 MiB           3   @profile
    16                                         def sum_of_numbers(quantity, number=1):
    17     19.5 MiB      0.0 MiB           3       if quantity == 1:
    18     19.5 MiB      0.0 MiB           1           return number
    19                                             else:
    20     19.5 MiB      0.0 MiB           2           return number + sum_of_numbers(quantity - 1, number / -2)
"""


"""
Из-за рекурсии получается несколько таблиц с замерами.
"""
...
"""
После того как мы обернули рекурсивную функцию обычной, осталась только 1 таблица"""