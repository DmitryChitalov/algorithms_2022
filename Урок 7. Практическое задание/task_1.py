...
"""
Оптимизация привела к увеличению времени выполнения алгоритма из-за дополнительных проверок. 
Оптимизация улучшает скорость выполнения при работе с отсортированными списками
"""
