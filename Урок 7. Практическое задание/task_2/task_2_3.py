...
# Встроенный метод statistics
m_10 = 5
numbers_list = [randint(-100, 100) for i in range(2*m_10+1)]
print(f'{numbers_list} - исходный список m_10')
time_func = timeit("statistics.median(numbers_list[:])", globals=globals(), number=10000)
print(f'{statistics.median(numbers_list)} - Медианный элемент')
...
# Аналитика
# [-16, 17, 85, 76, -84, -60, 51, 48, 38, 48, -72] - исходный список m_10
# 38 - Медианный элемент
# 0.010645399801433086 - время выполнения функции с m_10
# -9 - Медианный элемент
# 0.11168249975889921 - время выполнения функции с m_100
# -3 - Медианный элемент
# 1.2554203001782298 - время выполнения функции с m_1000




# Метод сортировки кучей (пирамидой)
