...
Вариант с предварительной сортировкой самый медленный и сильно деградирует по мере увеличения 
количества элементов в списке. Вариант без сортировки чуть лучше. И, как и следовало ожидать, встроенная функция
работает одинаково быстро на маленьких и больших объемах.
"""