...
'''Решение нашёл на просторах интернета понравилось, плюс есть decode, так как сам не очень понял тему,
перепечатал пытаясь вникнуть, в принципе, всё еще пытаюсь'''