...
Результат:
Сделал кодирование методом Haffman с помощью ООП :
вставил логику показанную на лекции  в ООП.
Дерево методоом ООП построить не смог.
Сам написал функции _coding и _decoding

Script listing @ lines 221:230
"""
import random
...
# Script listing:
#
#  sorted_elements : deque([('r', 1), ('!', 1), ('p', 2), (' ', 2), ('o', 2), ('b', 3), ('e', 4)])
#  code_table : {'b': '00', ' ': '010', 'o': '011', 'r': '1000', '!': '1001', 'p': '101', 'e': '11'}
#  encoded string :  0011111010100001101110101000111110001001
#  decoded string :  beep boop beer!
#
